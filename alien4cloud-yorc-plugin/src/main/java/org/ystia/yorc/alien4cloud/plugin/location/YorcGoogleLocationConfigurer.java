...
public class YorcGoogleLocationConfigurer extends AbstractLocationConfigurer
{
  ...
  public List<LocationResourceTemplate> instances(ILocationResourceAccessor resourceAccessor) {
    ImageFlavorContext imageContext = resourceGeneratorService.buildContext("yorc.nodes.google.Image", "id", resourceAccessor);
    ImageFlavorContext flavorContext = resourceGeneratorService.buildContext("yorc.nodes.google.MachineType", "id", resourceAccessor);
