...
exclude_patterns = ['target', 'Thumbs.db', '.DS_Store']
...
parent_elt = root.find(".//xmlns:parent", namespaces=namespaces)
if parent_elt is not None:
    version_elt = parent_elt.find("xmlns:version", namespaces=namespaces)
    if version is not None:
        version = version_elt.text
        release = version
